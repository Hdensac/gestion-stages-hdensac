        ...
        <div class="flex min-h-screen flex-col">
                ...
                <div class="w-full">
                    <div class="flex items-center justify-between py-3 px-4 md:px-6 lg:px-8">
                        ...
                        <nav v-if="canLogin" class="flex items-center">
                            <Link
                                :href="route('login')"
                                class="rounded-md px-5 py-2 bg-white text-gray-700 ring-1 ring-gray-300 transition-all duration-300 hover:bg-gray-100 hover:scale-105 focus:outline-none focus-visible:ring-[#2962B4] mr-2"
                            >
                                Se connecter
                            </Link>
                            ...
                            <Link
                                v-if="canRegister"
                                :href="route('register')"
                                class="rounded-md px-5 py-2 bg-[#2962B4] text-white ring-1 ring-[#2962B4] transition-all duration-300 hover:bg-[#1E4B8F] hover:scale-105 focus:outline-none focus-visible:ring-[#2962B4]"
                            >
                                S'inscrire
                            </Link>
                        </nav>
            ...
            >
                ...
                <section class="bg-white py-12 md:py-16">
                    <div class="w-full mx-auto px-4 md:px-6 lg:px-8">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                            <div class="transition-all duration-500" :class="{ 'opacity-100 translate-x-0': fadeIn, 'opacity-0 translate-x-[-20px]': !fadeIn }">
                                ...
                                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                                    <button 
                                        ...
                                        class="w-full sm:w-auto rounded-md px-8 py-3 bg-[#2962B4] text-white font-medium hover:bg-[#1E4B8F] hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#2962B4] transition-all duration-300 transform hover:scale-105"
                                    >
                                        Faire une demande
                                    </button>
                                    ...
                                    <button 
                                        ...
                                        class="w-full sm:w-auto rounded-md px-8 py-3 bg-white text-gray-700 font-medium border border-gray-300 hover:bg-gray-100 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#2962B4] transition-all duration-300 transform hover:scale-105"
                                    >
                            ...
                            <div class="bg-[#2962B4] text-white rounded-lg p-6 shadow-xl transition-all duration-500 transform hover:scale-102"
                ...
                <section class="py-12 bg-gray-50">
                    <div class="w-full mx-auto px-4 md:px-6 lg:px-8">
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 border-b-2 border-[#2962B4] pb-2 inline-block mb-6">
                        ...
                        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="bg-white p-4 rounded-lg shadow-md transition-transform duration-300 hover:shadow-lg hover:scale-105">
                                <div class="text-[#2962B4] text-2xl mb-2">
                ...
                <div class="w-full px-4 md:px-6 lg:px-8 mx-auto">
                    <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                        ...
                        <div class="flex space-x-4">
                            <a href="#" class="text-gray-600 hover:text-[#2962B4] transition-colors duration-300">
        ...
        >
            ...
            <div class="flex flex-col space-y-3">
                <button 
                    ...
                    class="w-full rounded-md px-5 py-2.5 bg-[#2962B4] text-white font-medium hover:bg-[#1E4B8F] focus:outline-none focus:ring-2 focus:ring-[#2962B4] transition-all duration-300 transform hover:scale-105"
                >
                    J'ai déjà un compte
                </button>
                ...
                <button 
                    ...
                    class="w-full rounded-md px-5 py-2.5 bg-white text-gray-700 font-medium border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#2962B4] transition-all duration-300 transform hover:scale-105"
                >
                    Créer un compte
                </button>
            </div>
