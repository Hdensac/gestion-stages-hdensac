    ...
    <div class="flex justify-center items-center min-h-screen bg-gray-50 py-8">
      <div class="bg-white shadow-xl rounded-2xl w-full max-w-2xl p-8 border border-blue-100">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-800">Modifier l'agent</h1>
        </div>
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex justify-end gap-2 mt-6">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 font-semibold">Enregistrer</button>
          </div>
        </form>
      </div>
    </div>
