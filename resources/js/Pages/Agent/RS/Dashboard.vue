    ...
    <template #header>
      <div class="flex items-center gap-4 mb-2">
        ...
        <div>
          ...
          <p class="text-base text-slate-600 mt-1 font-mono bg-slate-200/70 px-3 py-1 rounded-lg inline-block"></p>
        </div>
      </div>
    </template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-100 via-slate-100 to-gray-200">
      <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <!-- Information de la structure - thème bleu amélioré -->
          <div v-if="structure" class="bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 shadow-2xl rounded-3xl overflow-hidden border-2 border-blue-200/50 backdrop-blur-sm">
            <div class="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 py-8 px-10 relative overflow-hidden">
            ...
            <div class="p-10">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="group hover:scale-105 transition-all duration-300">
                  <div class="bg-white/80 rounded-2xl p-8 border-2 border-blue-200/50 hover:border-blue-300/50 hover:shadow-xl transition-all duration-300 shadow-lg">
                    <p class="text-sm font-bold text-blue-700 mb-3 uppercase tracking-wide">Sigle</p>
                    <p class="text-3xl font-black text-slate-800">{{ structure.sigle }}</p>
                  </div>
                </div>
                <div class="group hover:scale-105 transition-all duration-300">
                  <div class="bg-white/80 rounded-2xl p-8 border-2 border-blue-200/50 hover:border-blue-300/50 hover:shadow-xl transition-all duration-300 shadow-lg">
                    <p class="text-sm font-bold text-blue-700 mb-3 uppercase tracking-wide">Libellé</p>
                    <p class="text-2xl font-bold text-slate-800">{{ structure.libelle }}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="relative p-8">
                  <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-right">
                      <p class="text-4xl font-black text-slate-800 mb-2">{{ stats.demandesEnAttente }}</p>
              ...
              <div class="bg-gradient-to-br from-emerald-50 via-green-50 to-emerald-50 rounded-3xl shadow-2xl hover:shadow-3xl border-2 border-emerald-200/50 overflow-hidden relative">
                ...
                <div class="relative p-8">
                  <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-right">
                      <p class="text-4xl font-black text-slate-800 mb-2">{{ stats.demandesAcceptees }}</p>
                ...
                <div class="bg-gradient-to-r from-emerald-100 to-green-100 py-4 px-8 border-t-2 border-emerald-200/50">
                  <p class="text-sm font-bold text-emerald-800 flex items-center gap-3">
              ...
              <div class="bg-gradient-to-br from-red-50 via-rose-50 to-red-50 rounded-3xl shadow-2xl hover:shadow-3xl border-2 border-red-200/50 overflow-hidden relative">
                ...
                <div class="relative p-8">
                  <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-right">
                      <p class="text-4xl font-black text-slate-800 mb-2">{{ stats.demandesRejetees }}</p>
